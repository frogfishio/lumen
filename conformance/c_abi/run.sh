...
"$cc" -std=c11 -O2 -I"$root/conformance/c_abi/c" -c "$root/conformance/c_abi/c/probe.c" -o "$work/probe.o"
...
lumen build "$root/conformance/c_abi/lumen/test_abi.lm" --emit obj -o "$work/test_abi.o"
