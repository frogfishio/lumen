...
// Canonical: execute `action` when leaving the current scope.
// This is a language-agnostic primitive that can represent `defer`, `finally`,
// or structured scope cleanup.
static const Spec3FieldSig gl_fields_ScopeExit_0[] = {
    {"action", "rule", "*", false, false},
};
static const Spec3VariantSig gl_variants_ScopeExit[] = {
    {gl_fields_ScopeExit_0, sizeof(gl_fields_ScopeExit_0) / sizeof(gl_fields_ScopeExit_0[0])},
};

// Canonical: capability-gated block (e.g. unsafe/raw operations).
// `cap` MUST be a committed capability ID (e.g. "cap.unsafe"); do not infer
// meaning from token spellings.
static const Spec3FieldSig gl_fields_CapBlock_0[] = {
    {"cap", "tok", "*", false, false},
    {"body", "rule", "*", false, false},
};
static const Spec3VariantSig gl_variants_CapBlock[] = {
    {gl_fields_CapBlock_0, sizeof(gl_fields_CapBlock_0) / sizeof(gl_fields_CapBlock_0[0])},
};
...
// Canonical: qualified or segmented identifier path.
// Use this to carry name qualification structurally (parts) instead of encoding
// separators ("::"/"."/"/") into Name.id.text.
static const Spec3FieldSig gl_fields_Path_0[] = {
    {"parts", "tok", "*", false, true},
};
static const Spec3VariantSig gl_variants_Path[] = {
    {gl_fields_Path_0, sizeof(gl_fields_Path_0) / sizeof(gl_fields_Path_0[0])},
};
...
static const Spec3FieldSig gl_fields_StringUtf8_0[] = {
    {"lit", "tok", "*", false, false},
};
static const Spec3VariantSig gl_variants_StringUtf8[] = {
    {gl_fields_StringUtf8_0, sizeof(gl_fields_StringUtf8_0) / sizeof(gl_fields_StringUtf8_0[0])},
};
...
// Core string literal builtin: CSTR("...") should lower explicitly to CStr(lit).
...
const Spec3IntrinsicSig GL_SIG[] = {
    ...
    {"CapBlock", gl_variants_CapBlock, sizeof(gl_variants_CapBlock) / sizeof(gl_variants_CapBlock[0])},
    ...
    {"Path", gl_variants_Path, sizeof(gl_variants_Path) / sizeof(gl_variants_Path[0])},
    ...
    {"ScopeExit", gl_variants_ScopeExit, sizeof(gl_variants_ScopeExit) / sizeof(gl_variants_ScopeExit[0])},
    ...
    {"StringUtf8", gl_variants_StringUtf8, sizeof(gl_variants_StringUtf8) / sizeof(gl_variants_StringUtf8[0])},
